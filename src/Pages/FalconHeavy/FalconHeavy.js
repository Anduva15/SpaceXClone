...
const FalconHeavy = () => {
    ...
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white uppercase text-center font-familjen pb-40">
    ...
    <div className="bg-black">
        <div className="max-w-[960px] my-0 mx-auto flex flex-row justify-between align-middle text-center uppercase text-white">
            <Counter target="5" title="counterLaunches">
                Total Launches
            </Counter>
            <Counter target="11" title="counterLandings">
                Total Landings
            </Counter>
            <Counter target="6" title="counterReflights">
                Total Reflights
            </Counter>
