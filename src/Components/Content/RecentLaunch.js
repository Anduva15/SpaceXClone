...
const RecentLaunch = () => {
    return (
        <section className=" relative h-screen bg-[url('./section-b.png')] bg-center bg-no-repeat bg-cover">
        <div className="absolute bottom-[100px] sm:bottom-[200px] left-[50px] sm:left-[150px] text-white max-w-[560px]">
            <h4 className="animate-fadeInUp1 text-xl mb-1 font-light">Recent Lunch</h4>
            <h2 className="animate-fadeInUp2 animate-animateFill text-3xl font-bold mb-5">Starlink Mission</h2>
