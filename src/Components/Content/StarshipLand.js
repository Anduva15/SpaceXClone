...
const StarshipLand = () => {
    return (
        <section className=" relative h-screen bg-[url('./section-f.png')]">
        <div className="absolute bottom-[200px] left-[150px] text-white max-w-[560px]">
            <h2 className="animate-fadeInUp2 animate-animateFill text-3xl font-bold mb-5">Starship to add NASA astronaut on the moon</h2>
